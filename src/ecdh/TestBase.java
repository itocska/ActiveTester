...
public class TestBase {
	...
	public static void main(String arg, int close) throws Throwable {
		...
		password1 = prop.getProperty("pass1");
		user2 = prop.getProperty("user2");
		password2 = prop.getProperty("pass2");
		user3 = prop.getProperty("user3");
		password3 = prop.getProperty("pass3");
		user4 = prop.getProperty("user4");
		password4 = prop.getProperty("pass4");
		user5 = prop.getProperty("user5");
		password5 = prop.getProperty("pass5");
		userX = prop.getProperty("userX");
		cuser = prop.getProperty("cuser");
	...
	protected static void activateUser() throws Exception {
        ...
        driver.findElement(By.cssSelector("input[type=\"email\"]")).sendKeys("AKTIVÁLANDÓ EMAIL CÍM");
        driver.findElement(By.xpath("//*[text()='Következõ']")).click();
       
        wait.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector("input[type=password]")));
 
        driver.findElement(By.cssSelector("input[type=password]")).sendKeys("AKTIVÁLANDÓ EMAIL CÍM JELSZAVA");
        driver.findElement(By.xpath("//*[text()='Következõ']")).click();
        Log.log("Login Gmail");
	...
	public static void login(String userX) throws IOException {
		//byITOtest
		String user = "";
		String password = "";
		switch (userX) {
	...
	public static void registerCompany(String string, String email) throws IOException, AWTException, InterruptedException {
		...
		driver.findElement(By.id("user-password")).sendKeys(TestBase.password1);
		driver.findElement(By.id("user-confirm-password")).sendKeys(TestBase.password1);
	...
	public static void activateCompany(Boolean realActivation, String companyEmail) throws Exception {
		if (realActivation) {
		  driver.get(Gmail.getMails(TestBase.cuser, TestBase.password1, "ECDH", "href=\"(.*?)\">Addig is tekintsd meg"));
		}
